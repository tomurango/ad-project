...
#### 当初のコンセプト（2025-09）
**「広告をAI自動化 → 定型文より効果的 & 運用が楽」**

開発の動機：
- ユーザーもいない、サービスを作っているだけではダメ
- 発信・広告を何かしたらいいと思った
- AI自動化で効率的な広告運用を目指す

#### 現在のコンセプト（2025-10-31更新）
**「納得感を持った発信ツール」**

開発中の気づき：
- 何を誰に伝えたらいいのか不明確な状態がある
- 広告の目的を達成できないこともある（それが前提）
- でも発信を続けることには意味がある
- 「今この設定で発信している」という納得感が重要
...
**1. 納得感の3要素**
- **頻度**：今このペースで発信することに納得している
- **内容**：今この内容を発信することに納得している
- **場所**：今この場所に発信することに納得している
...
**「ユーザーがいない、作るだけじゃダメ」という不安を抱える開発者・クリエイター**

- 自分のプロジェクトを発信したいが、何をどう伝えたらいいか不明確
- 成果が出るか分からないけど、発信を続けたい
- 自動化したいけど、放置による違和感は避けたい
- プロジェクトの状態に応じて柔軟に調整したい

### 今後の方向性

#### Flutter移行（2025-10-31計画）
- **Electron版**：管理機能として残す
- **Flutter版**：日常的な確認・調整用のモバイルアプリ
- **理由**：
  - プッシュ通知で定期確認を促進
  - 常に持ち歩くデバイスで納得感を維持
  - 手軽なログイン・状態確認
...
#### ドメイン
- **購入済み**：`koukokuul`ドメイン
- **用途**：GitHub Pages カスタムドメイン（ランディングページ）

---

## 📋 プロジェクト概要（技術）
Electron + Firebase + AI統合の発信自動化プラットフォーム。複数AI対応、Twitter/Instagram等のSNS連携、プロジェクト状態に応じた柔軟な発信管理。
